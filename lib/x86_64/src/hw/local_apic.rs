...
impl LocalApic {
    ...
    pub fn enable_timer(duration: u32, apic_frequency: u32, vector: u8) {
        /*
    ...
    pub unsafe fn register(offset: usize) -> LocalApicRegister {
        LocalApicRegister::new(kernel_map::LOCAL_APIC_CONFIG.offset(offset as isize).mut_ptr() as *mut u32)
    }
