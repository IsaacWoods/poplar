; ModuleID = 'probe6.edf1bccdd5130aad-cgu.0'
source_filename = "probe6.edf1bccdd5130aad-cgu.0"
target datalayout = "e-m:e-p:64:64-i64:64-i128:128-n32:64-S128"
target triple = "riscv64"

; core::f64::<impl f64>::is_subnormal
; Function Attrs: inlinehint nounwind
define internal zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h1dce0bc0a5567bd5E"(double %self) unnamed_addr #0 {
start:
...
define dso_local void @_ZN6probe65probe17h136e5ef89d97976cE() unnamed_addr #1 {
start:
; call core::f64::<impl f64>::is_subnormal
  %_1 = call zeroext i1 @"_ZN4core3f6421_$LT$impl$u20$f64$GT$12is_subnormal17h1dce0bc0a5567bd5E"(double 1.000000e+00) #2
  ret void
}
