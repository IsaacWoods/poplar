...
impl LocalApic {
    ...
    pub unsafe fn register_ptr(&self, offset: usize) -> *mut u32 {
        let mapping = self
            .mapping
            .as_ref()
            .expect("Tried to get register ptr to unmapped local APIC");
        VirtualAddress::from(mapping.ptr)
    ...
    pub unsafe fn enable(
        ...
        self.mapping = Some(memory_controller.kernel_page_table.map_physical_region(
            register_base,
    ...
    pub fn enable_timer(&self, duration: usize) {
        ...
        unsafe {
            ...
            let ticks_in_10ms =
                (0xFFFF_FFFF - ptr::read_volatile(self.register_ptr(0x390))) as usize;
             ...
             */
            ptr::write_volatile(
                self.register_ptr(0x320),
                u32::from(::interrupts::LOCAL_APIC_TIMER) | 0x20000,
            );
            ptr::write_volatile(self.register_ptr(0x3E0), 0x3);
            ptr::write_volatile(
                self.register_ptr(0x380),
                ((ticks_in_10ms / 10) * duration) as u32,
            );
        }
    }
...
impl IoApic {
    ...
    unsafe fn read_register(&self, register: u32) -> u32 {
        let mapping = self
            .mapping
            .as_ref()
            .expect("Tried to read register for unmapped IOAPIC");
    ...
    unsafe fn write_register(&self, register: u32, value: u32) {
        ...
        ptr::write_volatile(mapping.ptr, register);
        ptr::write_volatile(
            VirtualAddress::from(mapping.ptr).offset(0x10).mut_ptr(),
            value,
        );
    }
