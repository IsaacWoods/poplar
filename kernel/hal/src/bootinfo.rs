...
pub enum MemoryType {
    ...
    /// Scratch entries are used to facilitate in-place manipulation of the memory map. They are
    /// used during memory map construction by the loader, and by the kernel for early physical
    /// memory allocation. They should otherwise be ignored, and all other fields of the entry are
    /// undefined.
    Scratch,
}
