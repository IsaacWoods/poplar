...
pub extern "C" fn kentry(boot_info: &BootInfo) -> ! {
    ...
    framebuffer.clear(Rgb32::pixel(0xffff00ff));
    framebuffer.draw_string("Hello from the kernel", 100, 100, Rgb32::pixel(0xff0000ff));
